        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SelectionStages_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobApprovals_AspNetUsers_ApprovedByUserId",
                        column: x => x.ApprovedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JobApprovals_JobPostings_JobPostingId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CandidateDocuments_Resumes_ResumeId",
                        column: x => x.ResumeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SelectionProcesses_JobApplications_JobApplicationId",
                        column: x => x.JobApplicationId,
                        principalTable: "JobApplications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SelectionProcesses_SelectionStages_CurrentStageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CandidateEvaluations_AspNetUsers_EvaluatorUserId",
                        column: x => x.EvaluatorUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CandidateEvaluations_SelectionProcesses_SelectionProcessId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Feedbacks_SelectionProcesses_SelectionProcessId",
                        column: x => x.SelectionProcessId,
                        principalTable: "SelectionProcesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StageMovementHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StageMovementHistories_AspNetUsers_ChangedByUserId",
                        column: x => x.ChangedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StageMovementHistories_SelectionProcesses_SelectionProcessId",
                        column: x => x.SelectionProcessId,
                        principalTable: "SelectionProcesses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StageMovementHistories_SelectionStages_FromStageId",
                        column: x => x.FromStageId,
                        principalTable: "SelectionStages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StageMovementHistories_SelectionStages_ToStageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CandidateDocuments_ResumeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CandidateEvaluations_SelectionProcessId",
                table: "CandidateEvaluations",
                column: "SelectionProcessId");

            migrationBuilder.CreateIndex(
                name: "IX_CandidateProfiles_Cpf",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyUsers_CompanyId_UserId_Role",
                table: "CompanyUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApprovals_ApprovedByUserId",
                table: "JobApprovals",
                column: "ApprovedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_JobApprovals_JobPostingId",
                table: "JobApprovals",
                column: "JobPostingId");

            migrationBuilder.CreateIndex(
                name: "IX_JobPostings_CompanyId_Title_ClosingDate",
                table: "JobPostings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SelectionProcesses_CurrentStageId",
                table: "SelectionProcesses",
                column: "CurrentStageId");

            migrationBuilder.CreateIndex(
                name: "IX_SelectionProcesses_JobApplicationId",
                table: "SelectionProcesses",
                column: "JobApplicationId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SelectionStages_CompanyId_Name",
                table: "SelectionStages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StageMovementHistories_ChangedByUserId",
                table: "StageMovementHistories",
                column: "ChangedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_StageMovementHistories_FromStageId",
                table: "StageMovementHistories",
                column: "FromStageId");

            migrationBuilder.CreateIndex(
                name: "IX_StageMovementHistories_SelectionProcessId",
                table: "StageMovementHistories",
                column: "SelectionProcessId");

            migrationBuilder.CreateIndex(
                name: "IX_StageMovementHistories_ToStageId",
                table: "StageMovementHistories",
                column: "ToStageId");
